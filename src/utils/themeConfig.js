...
const SCHEME_PALETTES = [
  ...
  [
    ...
    {
      mode: 'dark',
      primary:    { main: '#80CBC4', dark: '#4DB6AC', contrastText: '#000000' },
      secondary:  { main: '#FFAB91', dark: '#FF8A65', contrastText: '#000000' },
      background: { default: '#121212', paper: '#1E1E1E' },
      error:      { main: '#CF6679', contrastText: '#000000' },
      text:       { primary: 'rgba(255,255,255,0.87)', secondary: 'rgba(255,255,255,0.6)' },
    },
  ...
  [
    ...
    {
      mode: 'dark',
      primary:    { main: '#B0BEC5', dark: '#78909C', contrastText: '#000000' },
      secondary:  { main: '#EF9A9A', dark: '#E57373', contrastText: '#000000' },
      background: { default: '#121212', paper: '#1E1E1E' },
      error:      { main: '#CF6679', contrastText: '#000000' },
      text:       { primary: 'rgba(255,255,255,0.87)', secondary: 'rgba(255,255,255,0.6)' },
    },
  ...
  [
    ...
    {
      mode: 'dark',
      primary:    { main: '#BCAAA4', dark: '#8D6E63', contrastText: '#000000' },
      secondary:  { main: '#AED581', dark: '#9CCC65', contrastText: '#000000' },
      background: { default: '#121212', paper: '#1E1E1E' },
      error:      { main: '#CF6679', contrastText: '#000000' },
      text:       { primary: 'rgba(255,255,255,0.87)', secondary: 'rgba(255,255,255,0.6)' },
    },
  ...
  // 方案 6：翠藤萝（Green 600 / Deep Purple 400）
  [
    {
      mode: 'light',
    ...
    {
      mode: 'dark',
      primary:    { main: '#81C784', dark: '#66BB6A', contrastText: '#000000' },
      secondary:  { main: '#B39DDB', dark: '#9575CD', contrastText: '#000000' },
      background: { default: '#121212', paper: '#1E1E1E' },
      error:      { main: '#CF6679', contrastText: '#000000' },
      text:       { primary: 'rgba(255,255,255,0.87)', secondary: 'rgba(255,255,255,0.6)' },
    },
  ],
  // 方案 7：苍海珀（Cyan 700 / Amber 500）
  [
    {
      mode: 'light',
    ...
    {
      mode: 'dark',
      primary:    { main: '#80DEEA', dark: '#4DD0E1', contrastText: '#000000' },
      secondary:  { main: '#FFE082', dark: '#FFD54F', contrastText: '#000000' },
      background: { default: '#121212', paper: '#1E1E1E' },
      error:      { main: '#CF6679', contrastText: '#000000' },
      text:       { primary: 'rgba(255,255,255,0.87)', secondary: 'rgba(255,255,255,0.6)' },
    },
